...
$config = new Config('myproject', dirname(__DIR__), [
    ...
    'components' => [
        ...
        'mail' => [
            'isSMTP' => true,
            'host' => "beataprzybylska.com",
            'username' => "noreply@beataprzybylska.com",
            'password' => "qKg3WDmfTgxaHQDIFrnC",
            'from' => "noreply@beataprzybylska.com",
            'fromName' => "Beata Przybylska",
        ],
        /*
...
$config->component('db', [
    ...
    //'dsn' => 'mysql:host=localhost;dbname=architektura',
     //'dsn' => 'mysql:host=127.0.0.1;dbname=architektura;unix_socket=/Applications/MAMP/tmp/mysql/mysql.sock', // OSX MAMP
     //'dsn' => 'mysql:host=localhost;dbname=architektura;unix_socket=/Applications/XAMPP/xamppfiles/var/mysql/mysql.sock', // OSX XAMPP
    //'username' => 'root',
    //'password' => 'root',
])->env(Config::ENV_LOCAL);
